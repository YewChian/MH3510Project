...
As $Pr(>F) = 0.4213$, it is not small enough to justify inclusion of the variable $X3$ 

```{r}
anova(mlr_model_4, mlr_model_2)
```

Similarly, as $Pr(>F) = 0.3025$, it is not small enough to justify inclusion of the variable $log(X3)$ 
